...
export const DATA_SOURCE_TYPES = ['None', 'ReferenceData', 'ProductType', 'UnitOfMeasure', 'Category', 'ItemCategory', 'ItemCatalog', 'ProjectSubmission', 'ProjectProductList'] as const
